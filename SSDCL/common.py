...
def parse_args(default=False):
    ...
    parser.add_argument('--dataset', help='Dataset',
                        default='cifar10', type=str)#'cifar100', 'imagenet'
    parser.add_argument('--one_class_idx', help='None: multi-class, Not None: one-class',
                        default=0, type=int)
    parser.add_argument('--model', help='Model',
                        default='resnet18', type=str)#'resnet18_imagenet'
    parser.add_argument('--mode', help='Training mode',
                        default='simclr_CSI', type=str)# train:simclr_CSI test:ood_pre
    parser.add_argument('--simclr_dim', help='Dimension of simclr layer',
                        default=128, type=int)

    parser.add_argument('--shift_trans_type', help='shifting transformation type', 
                        default='rotation', type=str)#'cutperm', 'none','rotation'
    ...
    parser.add_argument('--load_path', help='Path to the loading checkpoint',
                        default='./logs/cifar10_resnet18_unsup_simclr_CSI_shift_rotation_one_class_0/last.model', type=str)
    ...
    parser.add_argument("--ood_layer", help='layer for OOD scores',
                        choices=['penultimate', 'simclr', 'shift','em_unfolding'],
                        default=['simclr', 'shift','penultimate','em_unfolding'], nargs="+", type=str)
