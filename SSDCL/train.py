...
#simclr_aug = C.get_simclr_augmentation(P)
...
if P.optimizer == 'sgd':
    ...
    #optimizer = LARS(model.parameters(), lr=P.lr_init,momentum=0.9,weight_decay=P.weight_decay)
    #lr_decay_gamma = 0.1
...
if P.resume_path is not None:
    ...
    #means_final.load_state_dict(means_state)
